...
async function resetDatabase() {
  ...
  try {
    console.log('🔄 Reinicializando base de datos MySQL...')
    ...
    console.error('❌ Error al reinicializar la base de datos:', error.message)
    console.log('\n🔧 Verifica que:')
...
async function insertMockData(connection) {
  ...
  mockDoctors.forEach(doctor => {
    ...
    console.log(`     Contraseña: ${doctor.role === 'admin' ? 'admin123' : '123456'}`)
  })
}
